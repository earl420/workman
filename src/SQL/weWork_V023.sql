...
select DRAFT_NUM AS "DOC_NUM" ,EMP_NUM AS "DOC_EMPNUM", DRAFT_TITLE AS "DOC_TITLE",
        DRAFT_CONTENT AS "DOC_CONTENT" , DRAFT_DATE AS "DOC_DATE", DRAFT_STATUS AS "DOC_STATUS"
from DOC_DRAFT
union
select EXPENSE_NUM AS "DOC_NUM" ,EMP_NUM AS "DOC_EMPNUM", EXPENSE_TITLE AS "DOC_TITLE", 
        EXPENSE_CONTENT AS "DOC_CONTENT" , EXPENSE_DATE AS "DOC_DATE", EXPENSE_STAUS AS "DOC_STATUS"
from DOC_EXPENSE
union
select HOLI_NUM AS "DOC_NUM" ,EMP_NUM AS "DOC_EMPNUM", HOLI_TYPE AS "DOC_TITLE", 
         HOLI_TYPE AS "DOC_CONTENT", HOLI_APPLY AS "DOC_DATE", HOLIDAY_STATUS AS "DOC_STATUS"
from DOC_HOLIDAY
union
select REQUEST_NUM AS "DOC_NUM" ,EMP_NUM AS "DOC_EMPNUM", REQUEST_TITLE AS "DOC_TITLE", 
         REQUEST_CONTENT AS "DOC_CONTENT", REQUEST_DATE AS "DOC_DATE", REQUEST_STATUS AS "DOC_STATUS"
from DOC_REQUEST
;
