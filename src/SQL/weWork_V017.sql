...
ALTER TABLE MANAGER
    ADD CONSTRAINT FK_MANAGER_EMP_NAME_EMPLOYEE_E FOREIGN KEY (EMP_NAME, EMP_NUM)
        REFERENCES EMPLOYEE (EMP_NAME, EMP_NUM)
/

ALTER TABLE MANAGER
    ADD CONSTRAINT FK_MANAGER_DEPT_NAME_DEPT_DEPT FOREIGN KEY (DEPT_NAME)
        REFERENCES DEPT (DEPT_NAME)
/

ALTER TABLE MANAGER
    ADD CONSTRAINT FK_MANAGER_GRADE_NAME_GRADE_GR FOREIGN KEY (GRADE_NAME)
