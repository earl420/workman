...
public class DraftSort {
	...
	public DraftSort(int pNum, int rNum, String draftNum, int deptNum, String empNum, String draftTitle,
			String draftContent, Date draftDate, String draftStatus, Date draftComplete, String approvalNum,
			String confirmNum) {
		super();
		this.pNum = pNum;
		this.rNum = rNum;
	...
	public String toString() {
		return "DraftSort [pNum=" + pNum + ", rNum=" + rNum + ", draftNum=" + draftNum + ", deptNum=" + deptNum
				+ ", empNum=" + empNum + ", draftTitle=" + draftTitle + ", draftContent=" + draftContent
				+ ", draftDate=" + draftDate + ", draftStatus=" + draftStatus + ", draftComplete=" + draftComplete
				+ ", approvalNum=" + approvalNum + ", confirmNum=" + confirmNum + "]";
	}
