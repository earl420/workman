...
public class RequestSort {
	...
	public RequestSort(int pNum, int rNum, String requestNum, int deptNum, String empNum, String requestTitle,
			String requestContent, Date requestDate, String requestStatus, Date requestComplete, String approvalNum,
			String confirmNum) {
		super();
		this.pNum = pNum;
		this.rNum = rNum;
	...
	public String toString() {
		return "RequestSort [pNum=" + pNum + ", rNum=" + rNum + ", requestNum=" + requestNum + ", deptNum=" + deptNum
				+ ", empNum=" + empNum + ", requestTitle=" + requestTitle + ", requestContent=" + requestContent
				+ ", requestDate=" + requestDate + ", requestStatus=" + requestStatus + ", requestComplete="
				+ requestComplete + ", approvalNum=" + approvalNum + ", confirmNum=" + confirmNum + "]";
	}
