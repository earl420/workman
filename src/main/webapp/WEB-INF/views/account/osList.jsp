		...
		<div class="content-body" style="min-height: 889px;">
			...
			<div class="row page-titles mx-0">
				<div class="col p-md-0">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="oslist.wo">총무회계</a></li>
						<li class="breadcrumb-item active"><a href="oslist.wo">OS관리</a></li>
					</ol>
				</div>
			</div>
			<!-- row -->
										...
										<div class="row">
											<div class="col-sm-12">
												<table
													...
													<thead>
														<tr role="row">
															<th style="width: 10%; text-align: center;">OS번호</th>
															<th rowspan="1" colspan="1"
																style="width: 30%; text-align: center;">제품명</th>
															<th rowspan="1" colspan="1"
																style="width: 15%; text-align: center;">라이센스번호</th>
															<th rowspan="1" colspan="1"
																style="width: 10%; text-align: center;">사용시작일</th>
															<th rowspan="1" colspan="1"
																style="width: 10%; text-align: center;">만료일</th>
														</tr>
													</thead>
													...
													<tbody>
														<c:forEach items="${ list }" var="i">
															<tr role="row" class="odd">
																<td class="sorting_1">${ i.licenseManage }</td>
																<td>${ i.productName }</td>
																<td>${ i.licenseNum }</td>
												...
												<div class="dataTables_paginate paging_simple_numbers"
													...
													<ul class="pagination">
														...
														<c:if test="${ pi.currentPage ne 1 }">
															<c:url value="oslist.wo" var="before">
																<c:param name="page"
														...
														<c:forEach begin="${ pi.startPage }" end="${ pi.endPage }"
															...
															<c:if test="${ p ne pi.currentPage }">
																<c:url value="oslist.wo" var="page">
														...
														<c:if test="${ pi.currentPage ne pi.maxPage }">
															<c:url value="oslist.wo" var="next">
																<c:param name="page"
																	value="${ pi.currentPage + 1 }" />
															</c:url>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<form method="post" id="modalForm" action="insertOs.wo">
       		<table class="table" id="updateSale">
       			...
       			<tr>
       				<th>제품 번호</th>
       				<td>
       					<input type="text" name="productCode" id="productCode" required="required" />
       				</td>
       			</tr>
       			<tr>
       				<th>거래처</th>
