...
<body>
											...
											<div class="p-t-15">
												...
												<div class="input-group icons"
													...
													<input type="search" class="form-control"
														placeholder="이름 검색" aria-label="Search Dashboard">
												</div>
												<br> <br>
	...
	<script>
		$(function(){
			document.querySelector(".sweet-confirm").onclick=function(){swal({title:"Are you sure to delete ?",text:"신청했던 휴가를 취소하시겠습니까?",type:"warning",showCancelButton:!0,confirmButtonColor:"#DD6B55",confirmButtonText:"yes",closeOnConfirm:!1},function(){swal("Deleted !!","휴가 신청이 취소되었습니다.","success")})};
		});
	</script>
