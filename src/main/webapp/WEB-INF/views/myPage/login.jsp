...
<body>
   ...
   <div class="main">
      ...
      <table>
         ...
         <tr>
            <td colspan="2">
               ...
               <div class="form-group">
                  <input type="text" class="form-control" id="empNo" name="empNo" onkeyup="test1();" placeholder="사원번호"> 
                  <small id="idLost" class="form-text text-muted"></small>
               </div>
            </td>
         </tr>
         <tr>
         ...
         <tr>
            <td><input type="checkbox" id="remember" name="rememberMe" value="true"/>사원번호 저장 </td>
            <!-- <td align="right"><a style="color:blue;" onclick="alert('연락하세요');">까먹음?또요?</a></td> -->
         </tr>
         <tr>
            <td colspan="2"><button type="submit" class="btn btn-dark">로그인</button></td>
         </tr>
      </table>
      </form>
   </div>
