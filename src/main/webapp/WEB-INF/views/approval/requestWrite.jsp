                                    	...
                                    	<tr>
                                            ...
                                            <th  width="80%">
                                            	<div class="member box_from" >
                                            		<ul>
                                            			<li class="alert">
                                            				<button type="button" class="btn mb-1 btn-rounded btn-success"  data-dismiss="alert" aria-label="Close">강연재 
                                            					<span class="btn-icon-right"><i class="fa fa-close"></i></span>
                                   							 </button>
                                   						</li>
                                            			<li class="alert">
                                            				<button type="button" class="btn mb-1 btn-rounded btn-success"  data-dismiss="alert" aria-label="Close">민병현 
                                            					<span class="btn-icon-right"><i class="fa fa-close"></i></span>
                                   							 </button>
                                   						</li>
                                            		</ul>
