...
<body>
	<div id="main-wrapper">
		...
		<div class="content-body" style="min-height: 884px;">
			...
			<form action="insertRequest.wo" method="post" encType="multipart/form-data">
				<div class="row">
					<div class="col-lg-12">
					<div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                        	...
                                        	<td colspan="2">
                                        		<input type="text" class="form-control" id="val-title" name="requestTitle" placeholder="제목등록">
                                        	</td>
										</tr>
										<tr>
										...
										<tr>
                                        	...
                                        	<th colspan="2">
                                        		<textarea id="ir1" rows="15" cols="137"  style="resize: none;"  name="requestContent"></textarea>
                                        	</th>
										</tr>
										<tr>
