			...
			<div class="row page-titles mx-0">
				<div class="col p-md-0">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">기안서</a></li>
					</ol>
				</div>
			</div>
			<!-- row -->
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                        	...
                                        	<td colspan="6">
                                        		<input type="text" class="form-control" value="${ d.draftTitle }" readonly="readonly">
                                        	</td>
										</tr>
										 <tr>
                                        	<td align="center" width="10%">등록일</td>
                                        	<td colspan="2" width="20%">
                                        		<input type="text" class="form-control" value="${ d.draftDate }" style="text-align:center;" readonly="readonly">
                                        	</td>
                                        	<td align="center" width="10%">완료일</td>
                                        	<td colspan="2" width="20%">
                                        		<input type="text" class="form-control" value="${ d.draftComplete }" style="text-align:center;" readonly="readonly">
                                        	</td>
                                        	<td width="40%">
                                        	</td>
										</tr>
										...
										<tr>
                                        	...
                                        	<th colspan="6">
                                        		<textarea rows="15" cols="137"   readonly="readonly" style="resize: none;">${ d.draftContent }</textarea>
                                        	</th>
										</tr>
										<tr>
                                        	<td colspan="10" align="center">
                                        		...
                                        		<button type="button" onclick="location.href='${ draftUpdate }'"  class="btn mb-1 btn-outline-primary btn-lg">&nbsp;수정 &nbsp;</button> &nbsp;&nbsp;
                                        		</c:if>
                                        		<c:choose>
                                        			<c:when test="${ loginMan.num eq c.confirmEmp1 and c.confirmDate1 eq null}">
                                        				<c:url value="successDraft.wo" var="successDraft">
                                        					<c:param name="confirmNum" value="${ d.confirmNum}"/>
                                        					<c:param name="draftNum" value="${ d.draftNum}"/>
                                        					<c:param name="count" value="1"/>
														</c:url>
                                        					<button type="button" onclick="location.href='${ successDraft }'" class="btn mb-1 btn-outline-primary btn-lg">&nbsp;승인하기 &nbsp;</button> &nbsp;&nbsp;
                                        			</c:when>
