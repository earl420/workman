		...
		<div class="content-body" style="min-height: 884px;">
			<div class="row page-titles mx-0">
				<div class="col p-md-0">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="javascript:void(0)">전체목록</a></li>
					</ol>
				</div>
			</div>
			<!-- row -->
									...
									<table class="table" id="listArea">
										...
										<c:forEach items="${ doclist }" var="d">
											<tr>
												...
												<c:if test="${fn:startsWith(name,'DRAFT')}">
												<td align="left">기안서</td>
												</c:if>
												<c:if test="${fn:startsWith(name,'EXPENSE')}">
												<td align="left">지출결의서</td>
												</c:if>
												<c:if test="${fn:startsWith(name,'HOLI')}">
												<td align="left">휴가</td>
												</c:if>
												<c:if test="${fn:startsWith(name,'REQ')}">
												...
												<c:choose>
													...
													<c:when test="${d.docStatus eq 'P'}">
														<td align="center"><span class="label label-info">진행</span></td>
													</c:when>
														...
														<nav>
															...
															<!-- 이전 -->
																...
																<c:if test="${ pi.currentPage ne 1 }">
																	<c:url value="allList.wo" var="page">
															...
															<!-- 번호들 -->
																...
																<c:if test="${ pi.currentPage ne pi.maxPage }">
																	<c:url value="allList.wo" var="next">
																		<c:param name="currentPage" value="${ pi.currentPage + 1 }"/>
																	</c:url>
