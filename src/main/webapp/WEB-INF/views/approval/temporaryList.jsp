		...
		<div class="content-body" style="min-height: 884px;">
			<div class="row page-titles mx-0">
				<div class="col p-md-0">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="javascript:void(0)">문서보관</a></li>
						<li class="breadcrumb-item active"><a href="javascript:void(0)">임시저장</a></li>
					</ol>
				</div>
			</div>
			<!-- row -->
									...
									<table class="table">
										...
										<tbody>
											<tr>
												...
												<td>휴가</td>
												<td>문서기안</td>
												<td><span class="label label-primary">임시저장</span></td>
												<td>2018-09-04</td>
												<td>나나나</td>
											</tr>
											<tr>
